...
external val CONSTRUCTION_COST_ROAD_SWAMP_RATIO: Number
...
external var CREEP_SPAWN_TIME: Number
external var CREEP_LIFE_TIME: Number
external var CREEP_CLAIM_LIFE_TIME: Number
external var CREEP_CORPSE_RATE: Number
external var OBSTACLE_OBJECT_TYPES: dynamic
external val ENERGY_REGEN_TIME: Number
external val ENERGY_DECAY: Number
external val REPAIR_COST: Number
external val RAMPART_DECAY_AMOUNT: Number
external val RAMPART_DECAY_TIME: Number
external val RAMPART_HITS: Number
external val ROAD_HITS: Number
external val ROAD_WEAROUT: Number
external val ROAD_DECAY_AMOUNT: Number
external val ROAD_DECAY_TIME: Number
external val LINK_HITS: Number
external val LINK_HITS_MAX: Number
external val LINK_CAPACITY: Number
external val LINK_COOLDOWN: Number
external val LINK_LOSS_RATIO: Number
external val STORAGE_CAPACITY: Number
external val STORAGE_HITS: Number
external val BODYPARTS_ALL: Array<BodyPartConstant>
external val CARRY_CAPACITY: Number
external val HARVEST_POWER: Number
external val HARVEST_MINERAL_POWER: Number
external val REPAIR_POWER: Number
external val DISMANTLE_POWER: Number
external val BUILD_POWER: Number
external val ATTACK_POWER: Number
external val UPGRADE_CONTROLLER_POWER: Number
external val RANGED_ATTACK_POWER: Number
external val HEAL_POWER: Number
external val RANGED_HEAL_POWER: Number
external val DISMANTLE_COST: Number
